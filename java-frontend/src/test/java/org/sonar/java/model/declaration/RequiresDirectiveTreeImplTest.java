...
public class RequiresDirectiveTreeImplTest {
  ...
  public void transitive_as_name() {
    ...
    assertThat(((IdentifierTree) requires.moduleName()).name()).isEqualTo("transitive");
  ...
  public void requires() {
    ...
    ExpressionTree moduleName = requires.moduleName();
    assertThat(moduleName.is(Tree.Kind.MEMBER_SELECT)).isTrue();
    MemberSelectExpressionTree mset = (MemberSelectExpressionTree) moduleName;
    assertThat(((IdentifierTree) mset.expression()).name()).isEqualTo("foo");
    assertThat(mset.identifier().name()).isEqualTo("bar");
    assertThat(requires.semicolonToken().text()).isEqualTo(";");
  }
  ...
  public void test_BaseTreeVisitor() {
    ...
    assertThat(moduleDeclarationVisitor.identifiers).containsExactly("Bar", "Bar", "greetings", "gul", "qix");
  }
